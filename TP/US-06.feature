Feature: US06 - Filtrado de Objetos
  ...
  Scenario: Aplicación de Filtros
    Given el usuario intercambiador está en la sección de objetos disponibles para intercambio
  ...
  Scenario: Visualización de Resultados Filtrados
    Given el usuario ha aplicado filtros por estado a la lista de objetos disponibles
  ...
  Scenario: Filtrar por cantidad de Vistas
    Given el usuario está buscando objetos con la mayor cantidad de vistas para intercambiar
